...
class LANMessengerApp(ctk.CTk):
    ...
    def create_sidebar(self):
        ...
        self.change_name_btn = ctk.CTkButton(username_frame, text="Set", width=30, command=self.update_username)
    ...
    def create_main_area(self):
        ...
        self.my_files_btn = ctk.CTkButton(self.file_controls, text="My Shared Files", command=self.show_local_files)
