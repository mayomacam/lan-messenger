...
class LANMessengerApp(ctk.CTk):
        ...
        while True:
            try:
                ...
                if msg_count > 0 or file_count > 0:
                    ...
                    self.after(0, self._refresh_after_reap, msg_count)
    ...
    def refresh_peers(self):
        ...
        # Batch fetch all permissions for O(1) performance
    ...
    def edit_last_message(self):
        ...
        if not my_msgs:
            ...
            return
        # Messages are returned Oldest to Newest, so the last one is the most recent
        last_msg = my_msgs[-1]
