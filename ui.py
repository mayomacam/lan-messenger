...
class MFASetupDialog(ctk.CTkToplevel):
    def __init__(self, parent, db, on_complete_cb=None):
        ...
        ctk.CTkLabel(secret_frame, text=f"Secret Key: {self.secret}", font=("Courier", 12)).pack(side="left")
        self.copy_btn = ctk.CTkButton(secret_frame, text="Copy", width=50, height=20, command=self.copy_secret)
